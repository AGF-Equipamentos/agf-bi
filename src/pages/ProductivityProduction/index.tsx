...
const ProductivityProduction: React.FC = () => {
  ...
  const { data } = useFetch<Data[]>(
    `ops?filial=0101&fechado=true&ano=2024&produto=${products.join("','")}`,
    {},
    6000,
  );
  const realizedHours = 7402.13;
